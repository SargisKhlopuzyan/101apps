...
public class DisplayImage extends Activity {
    ...
    private void getFileOutOfCache(String fileName) {
        ...
        File myCachedFile = new File(myDiskCacheFilePath + File.separator + fileName);
        ...
        if (myCachedFile.exists()) {
            ...
            Toast.makeText(this, "The cached file does not exist", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void getBitmapFromPublicFile() {
        ...
        if (diskState.equals(MEDIA_MOUNTED)) {
            ...
            File filePicture = new File(pictureFolder,"MyCachedImage.jpg");
            ...
            if (filePicture.exists()) {
                ...
                Toast.makeText(this, "The public file does not exists", Toast.LENGTH_SHORT).show();
            }
        } else {
