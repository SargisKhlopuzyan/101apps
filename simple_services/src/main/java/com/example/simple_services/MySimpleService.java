    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        switch (flags) {
            ...
            case START_FLAG_RETRY:
                Log.i(TAG, "retrying original intent in Service as first attempt failed");
...
//        set thread priority to slightly lower than main thread so has minimal affect on it
