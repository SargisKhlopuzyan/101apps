...
public class ContactsListFragment extends ListFragment {
    ...
    /* this interface ust be implemented by host activity */
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1, contactsList);
